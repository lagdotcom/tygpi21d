...
OBJECTS = {
	...
	'MAIN': ['DOSJUN', 'CAMPAIGN', 'CODE', 'COMBAT', 'DJN', 'FONT', 'FP', 'GFX', 'GRF', 'INPUT', 'IO', 'ITEMS', 'JFIGHTER', 'JCLERIC', 'JMAGE', 'JBARD', 'JROGUE', 'JRANGER', 'JOBS', 'LIST', 'LOGGING', 'MAIN', 'MEM', 'MONSTERS', 'MUS_SNG', 'MUSIC', 'PARTY', 'SAVE', 'SOUND', 'STATUS', 'TIMER', 'ZONE'],
